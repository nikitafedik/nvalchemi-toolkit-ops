...
def _benchmark_d3_jax(data, cutoff, d3_params, d3_func_params, num_runs, warmup_runs):
    ...
    # D3 timing — reuse the NL buffers we already have. Time a compiled fixed-shape
    # D3 callable, matching JAX benchmarking guidance and the 0.3.1 benchmark path.
...
def run_from_config(
    ...
    try:
        ...
        error = (
            f"{exc}. Run: python examples/dispersion/01_dftd3_molecule.py "
